 ...
 * @e_ident: pointer to an array containing the ELF magic nmbrs.
...
/*
 * print_version - funtion to prints the version of an ELF header.
 * @e_ident: pointr to an array containing the ELF version.
 */
void print_version(unsigned char *e_ident)
{
	 printf(" Version: %d",
 ...
 * @e_ident: pointer to an array containing the ELF ABI vrsn.
 */
void print_abi(unsigned char *e_ident)
{
...
/*
 * print_entry - a function that prints the entry
...
/*
 * main - function that displays the information
 * contained in the ELF header at the start of an ELF file.
 * @argc: numbr of arguments suppld to the program.
